...
class CtdpfCklWfpDataSetDriver(MultipleHarvesterDataSetDriver):
    ...
    def __init__(self,
        ...
        harvester_type = {
            DataTypeKey.CTDPF_CKL_WFP_RECOVERED: HarvesterType.SINGLE_DIRECTORY,
            DataTypeKey.CTDPF_CKL_WFP_TELEMETERED: HarvesterType.SINGLE_DIRECTORY
        }
    ...
    def _build_harvester(self, driver_state):
        ...
        if DataTypeKey.CTDPF_CKL_WFP_RECOVERED in self._harvester_config:
            ...
            if harvester is not None:
                ...
                log.debug('CTDPF_CKL_WFP_RECOVERED HARVESTER NOT BUILT')
        #
        ...
        if DataTypeKey.CTDPF_CKL_WFP_TELEMETERED in self._harvester_config:
            ...
            if harvester is not None:
                ...
                log.debug('CTDPF_CKL_WFP_TELEMETERED HARVESTER NOT BUILT')
