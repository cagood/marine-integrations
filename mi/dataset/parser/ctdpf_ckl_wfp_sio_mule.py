        ...
        if self.raw_data[3] is not None:
            result = [self._encode_value(CtdpfCklWfpSioMuleMetadataParticleKey.WFP_TIME_ON,
                      ...
                      self._encode_value(CtdpfCklWfpSioMuleMetadataParticleKey.WFP_NUMBER_SAMPLES,
                                         self.raw_data[2], int),
                      self._encode_value(CtdpfCklWfpSioMuleMetadataParticleKey.WFP_DECIMATION_FACTOR,
                                         self.raw_data[3], int)
            ]
        else:
            result = [{DataParticleKey.VALUE_ID: CtdpfCklWfpSioMuleMetadataParticleKey.WFP_TIME_ON,
                       DataParticleKey.VALUE: int(self.raw_data[0])},
                      {DataParticleKey.VALUE_ID: CtdpfCklWfpSioMuleMetadataParticleKey.WFP_TIME_OFF,
                       DataParticleKey.VALUE: int(self.raw_data[1])},
                      {DataParticleKey.VALUE_ID: CtdpfCklWfpSioMuleMetadataParticleKey.WFP_NUMBER_SAMPLES,
                       DataParticleKey.VALUE: int(self.raw_data[2])},
                      {DataParticleKey.VALUE_ID: CtdpfCklWfpSioMuleMetadataParticleKey.WFP_DECIMATION_FACTOR,
